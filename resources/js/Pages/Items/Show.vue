                            ...
                            <div class="container px-5 py-8 mx-auto">
                                ...
                                <div class="flex flex-wrap -m-2">
                                    ...
                                    <div class="relative">
                                        ...
                                        <div id="status" name="price" class="w-full bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
